...
export default function NewArrivalsScreen({ navigation }: any) {
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      <Icon name="sparkles-outline" size={64} color="#9ca3af" />
      <Text style={styles.emptyText}>No new arrivals</Text>
      <Text style={styles.emptySubtext}>Check back later for fresh products</Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        keyExtractor={(item, index) => item.id?.toString() || `newarrival-${index}`}
        numColumns={2}
