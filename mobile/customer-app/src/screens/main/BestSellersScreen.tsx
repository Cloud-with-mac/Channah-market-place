...
export default function BestSellersScreen({ navigation }: any) {
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      <Icon name="trending-up-outline" size={64} color="#9ca3af" />
      <Text style={styles.emptyText}>No best sellers yet</Text>
      <Text style={styles.emptySubtext}>Check back later for top products</Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        keyExtractor={(item, index) => item.id?.toString() || `bestseller-${index}`}
        numColumns={2}
