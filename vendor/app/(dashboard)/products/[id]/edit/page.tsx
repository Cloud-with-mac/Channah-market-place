...
import { ArrowLeft, X, Loader2, ImagePlus, Trash2, Upload, Link as LinkIcon } from 'lucide-react'
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const productRes = await vendorProductsAPI.get(productId)
